...
class NodeRtmpSession {
  constructor(socket, server) {
    ...
    this.outChunkSize = server.rtmpServer.chunk_size
      ? server.rtmpServer.chunk_size
      : RTMP_CHUNK_SIZE;
    this.pingTime = server.rtmpServer.ping
      ? server.rtmpServer.ping * 1000
      : RTMP_PING_TIME;
    this.pingTimeout = server.rtmpServer.ping_timeout
      ? server.rtmpServer.ping_timeout * 1000
      : RTMP_PING_TIMEOUT;
